...
import FinancialCoachDemo from "@/components/finance/FinancialCoachDemo";

export const metadata = {
  title: "AI Personal Financial Shopping Coach — BelanjAI",
};

export default function FinancialCoachPage() {
  const feature = getFeature("financial-coach");
